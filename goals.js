...
function editMainGoal() {
  ...
  let goal = JSON.parse(localStorage.getItem("main-goal"));
...
function editDailyGoal() {
  let daily_goal = JSON.parse(
    localStorage.getItem("daily-goal") ?? {
      calories: "none",
      protein: "none",
      fat: "none",
      carbs: "none",
...
function loadGoals() {
  let main_goal = JSON.parse(
    localStorage.getItem("main-goal") ?? {
      start_date: "none",
      start_weight: "none",
      goal_weight: "none",
      goal_date: "none",
